...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        return http.
                ...
                .requestMatchers("/api/posts/**").permitAll()//帖子相关的请求全部放行
                .requestMatchers("/api/comments/**").permitAll()//评论相关的请求全部放行
                .requestMatchers("/api/likes/**").permitAll()//表白相关的请求全部放行
                .requestMatchers("/api/manage/**").permitAll()//管理相关的请求全部放行
    ...
    private CorsConfigurationSource corsConfigurationSource(){
        ...
        // 添加日志
        System.out.println("CORS配置已应用: " + cors.getAllowedOriginPatterns());
        System.out.println("允许凭证: " + cors.getAllowCredentials());
